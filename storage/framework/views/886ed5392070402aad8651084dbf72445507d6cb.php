            ...
            <div class="panel panel-primary panel-primary-insurance">
              ...
              <div class="panel-body addressField"><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-12">
                    <input type="number" class="form-control addressFields" required id="postcode" name="postcode" value="" maxlength="5">
                  </div>
                </div><br>
              </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Final file\5\stillwaters\resources\views/insurances/details.blade.php ENDPATH**/ ?>