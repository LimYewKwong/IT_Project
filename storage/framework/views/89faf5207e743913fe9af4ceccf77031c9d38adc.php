...
<div class="container container_secondary">
  <div class="content_secondary">
    ...
    <form class="insuranceForm" action="payment" method="post">
      ...
      <input type="hidden" name="ref_id" value="<?php echo e(rand(10000 ,99999).time()); ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <center>
                ...
                <h4 style="color: #02D486"><b>RM <?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></b></h4>
              </center>
            </div>
            <div class="col-md-3 col-sm-6">
              <center>
                <small>YOUR SUM ASSURED</small><br>
                <h4><b>RM <?php echo e(number_format($insurance_providers[0]->sum_insured, 2)); ?></b></h4>
              </center>
            </div>
          </div><br>
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-primary panel-primary-insurance">
                <div class="panel-heading panel-heading-insurance">
                  <span>Car Info</span>
                  <span class="pull-right car_number"><?php echo e($car_details[0]->car_number); ?></span>
                  <input type="text" name="car_id" value="<?php echo e($car_details[0]->id); ?>" hidden>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <table class="table table-bordered insurance-table">
                        ...
                        <tbody>
                          <tr>
                            <td><?php echo e($car_details[0]->variant); ?></td>
                            <td><?php echo e($car_details[0]->style); ?></td>
                            <td><?php echo e($car_details[0]->transmission); ?></td>
                            <td><?php echo e($car_details[0]->cc); ?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                      <table style="width: 100%;">
                        <tr>
                          ...
                          <td style="width: 60%;">
                            <input type="text" class="form-control" value="<?php echo e($car_details[0]->year); ?>" disabled>
                          </td>
                        </tr>
                      </table><br>
                      <table style="width: 100%;">
                        <tr>
                          ...
                          <td style="width: 60%;">
                            <input type="text" class="form-control" value="<?php echo e($car_details[0]->seating_capacity); ?>" disabled>
                          </td>
                        </tr>
                      </table><br>
                    </div>
                    <div class="col-md-6 col-sm-12">
                      <table style="width: 100%;">
                        <tr>
                          ...
                          <td style="width: 60%;">
                            <input type="text" class="form-control" value="<?php echo e($car_details[0]->engine_number); ?>" disabled>
                          </td>
                        </tr>
                      </table><br>
                      <table style="width: 100%;">
                        <tr>
                          ...
                          <td style="width: 60%;">
                            <input type="text" class="form-control" value="<?php echo e($car_details[0]->chasis_number); ?>" disabled>
                          </td>
                        </tr>
                      </table><br>
                    </div>
                  ...
                  <center>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <span style="font-size: 50px; font-weight: bold;">RM <?php echo e(number_format($insurance_providers[0]->sum_insured)); ?></span><br><br>
                ...
                <div class="panel-body"><br>
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <input type="text" value="<?php echo e(session()->get('insurance_data.ic_number')); ?>" class="form-control" disabled>
                      <input type="hidden" value="<?php echo e(session()->get('insurance_data.ic_number')); ?>" class="form-control" hidden name="ic_number">
                    </div>
                  </div><br>
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <input type="text" value="<?php echo e(session()->get('insurance_data.full_name')); ?>" class="form-control" disabled>
                      <input type="hidden" value="<?php echo e(session()->get('insurance_data.full_name')); ?>" class="form-control" hidden name="full_name">
                    </div>
                  </div><br>
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <input type="text" value="<?php echo e(session()->get('insurance_data.mobile')); ?>" class="form-control" disabled>
                      <input type="hidden" value="<?php echo e(session()->get('insurance_data.mobile')); ?>" class="form-control" hidden name="mobile">
                    </div>
                  </div><br>
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <input type="text" value="<?php echo e(session()->get('insurance_data.email')); ?>" class="form-control" disabled>
                      <input type="hidden" value="<?php echo e(session()->get('insurance_data.email')); ?>" class="form-control" hidden name="email">
                    </div>
                  </div><br>
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                    ...
                    <div class="col-md-8 col-sm-12">
                      ...
                      <input type="hidden" value="<?php echo e(session()->get('insurance_data.maritial_status')); ?>" class="form-control" hidden name="maritial_status">
                    </div>
                  </div><br>
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
            ...
            <div class="col-md-12">
              <div class="panel panel-primary panel-primary-insurance">
                ...
                <div class="panel-body"><br>
                  <div class="row">
                    ...
                    <span style="position: relative; top: -20px; width: 100%; font-weight: bold; font-size: 10px; width:100%;">
                      ...
                      <span style="width:30%; display:inline-block; text-align:center;">EFFECTIVE DATE: <?php echo e(date('d-m-Y')); ?></span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-12">
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo e($car_details[0]->no_claim); ?>"
                        aria-valuemin="0" aria-valuemax="100" style="width:<?php echo e($car_details[0]->no_claim*1.8); ?>%; background-color: #FE6055;">
                        <?php echo e($car_details[0]->no_claim); ?>%
                      </div>
                    </div>
                    <span style="position: relative; top: -20px; width: 100%; font-weight: bold; font-size: 10px; width:100%;">
                      <span style="width:30%; display:inline-block; float: left">0%</span>
            ...
            <div class="panel panel-primary panel-primary-insurance">
              ...
              <div class="panel-body"><br>
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12">
                    <input type="text" value="<?php echo e(date('d-m-Y')); ?>" class="form-control" disabled>
                    <input type="hidden" value="<?php echo e(date('Y-m-d')); ?>" class="form-control" name="start_date" hidden>
                  </div>
                  <div class="col-md-2 col-sm-12">
                    End Date
                  </div>
                  <div class="col-md-4 col-sm-12">
                    <input type="text" value="<?php echo e(date('d-m-Y', strtotime('+364 days'))); ?>" class="form-control" disabled>
                    <input type="hidden" value="<?php echo e(date('Y-m-d', strtotime('+364 days'))); ?>" class="form-control" name="end_date" hidden>
                  </div>
                </div><br>
              </div>
            </div>
                  ...
                  <div class="panel-body" style="padding: 0 0 20px 0;">
                    <table class="table table-bordered insurance-table addon-table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo e($addon->description); ?><span class="pull-right" style="color: grey;"><i class="fas fa-info-circle"></i></span></td>
                          <td style="text-align: center;">RM <?php echo e(number_format($addon->amount, 2)); ?></td>
                          <td style="text-align: center;"><input type="radio" name="addon_id_<?php echo e($addon->id); ?>" value="<?php echo e($addon->id); ?>" data-amount="<?php echo e($addon->amount); ?>"></td>
                        </tr>
          ...
          <div class="col-md-4 col-sm-12">
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-primary panel-primary-insurance">
                  <div class="panel-heading panel-heading-insurance">
                    <span><?php echo e($insurance_providers[0]->name); ?></span>
                    <input type="text" name="provider_id" value="<?php echo e($insurance_providers[0]->id); ?>" hidden>

                  </div>
                  <div class="panel-body">
                    <span style="color: #206799; font-weight: bold">Your Premium</span><hr>
                    <small>Sum Insured</small><br>
                    <span>RM <?php echo e(number_format($insurance_providers[0]->sum_insured, 2)); ?></span><br><br>
                    <small>Basic Premium</small><br>
                    <span>RM <?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></span><br><br>
                    <small>Subtotal</small><br>
                    <span>RM <?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></span><hr>
                    <span style="color: #206799; font-weight: bold">Optional Add-Ons</span><hr>
                    <small>Subtotal</small><br>
                    <span>RM <span id="addOnTotal"><?php echo e(number_format(0, 2)); ?></span></span><hr>
                    <small>Total Payable</small><br>
                    <span class="headerfont">RM <span id="totalPayable"><?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></span></span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div id="finalDetails" class="tab-pane">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <center>
              <small>TOTAL PAYABLE</small><br>
              <h4 style="color: #02D486"><b>RM <span id="totalPayableDetails"><?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></span></b></h4>
            </center>
          </div>
          <div class="col-md-3 col-sm-6">
            <center>
            ...
            <div class="panel panel-primary panel-primary-insurance">
              ...
              <div class="panel-body addressField"><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-12">
                    <input type="number" value="<?php echo e(session()->get('insurance_data.postcode')); ?>" class="form-control addressFields" required id="postcode" name="postcode" value="" maxlength="5" disabled>
                  </div>
              ...
              <div class="col-md-12">
                <div class="panel panel-primary panel-primary-insurance">
                  ...
                  <div class="panel-body" style="padding: 10px 40px;"><br>
                    ...
                    <span><?php echo e(session()->get('insurance_data.full_name')); ?></span><hr>
                    <small>Email:</small><br>
                    <span><?php echo e(session()->get('insurance_data.email')); ?></span><hr>
                    <small>NRIC:</small><br>
                    <span><?php echo e(session()->get('insurance_data.ic_number')); ?></span><hr>
                    <small>Mobile Number:</small><br>
                    <span><?php echo e(session()->get('insurance_data.mobile')); ?></span><br><br>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-12">
                <div class="panel panel-primary panel-primary-insurance">
                  ...
                  <div class="panel-body" style="padding: 10px 40px;">
                    <center>
                      <img src="<?php echo e(url('/images/'.$car_details[0]->brand_logo)); ?>" alt="Brand Image" height="150px;"><br><br>
                      <span>Your Car</span><br>
                      <span class="headerfont"><?php echo e($car_details[0]->brand." ".$car_details[0]->variant." ".$car_details[0]->style." ".$car_details[0]->transmission); ?></span><br><br>
                    </center>
                    <div class="row">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <span><?php echo e($car_details[0]->car_number); ?></span><br><br>
                        <small>Seating Capacity</small><br>
                        <span><?php echo e($car_details[0]->seating_capacity); ?></span><br><br>
                        <small>Engine No.</small><br>
                        <span><?php echo e($car_details[0]->engine_number); ?></span><br><br>
                      </div>
                      <div class="col-md-6 col-sm-12">
                        <small>Year of Make</small><br>
                        <span><?php echo e($car_details[0]->year); ?></span><br><br>
                        <small>C.C.</small><br>
                        <span><?php echo e($car_details[0]->cc); ?></span><br><br>
                        <small>Chasis No.</small><br>
                        <span><?php echo e($car_details[0]->chasis_number); ?></span><br><br>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="panel-body" style="padding: 10px 40px;"><br>
                    <div class="row">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <span><?php echo e(date('d-m-Y')); ?></span><br><br>
                      </div>
                      <div class="col-md-6 col-sm-12">
                        <small>Policy End Date</small><br>
                        <span><?php echo e(date('d-m-Y', strtotime('+364 days'))); ?></span><br><br>
                      </div>
                    </div>
              ...
              <div class="col-md-12">
                <div class="panel panel-primary panel-primary-insurance">
                  ...
                  <div class="panel-body">
                    ...
                    <span style="color: #206799; font-weight: bold">Optional Add-Ons</span><hr>
                    <small>Subtotal</small><br>
                    <span>RM <span id="addOnTotalFinal"><?php echo e(number_format(0, 2)); ?></span></span><hr>
                    <small>Total Payable</small><br>
                    <span class="headerfont">RM <span id="totalPayableFinal"><?php echo e(number_format($insurance_providers[0]->amount, 2)); ?></span></span>
                    <input type="text" name="final_amount" value="<?php echo e(number_format($insurance_providers[0]->amount, 2)); ?>" id="amount" hidden>
                  </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\IT_Project\resources\views/insurances/details.blade.php ENDPATH**/ ?>