  ...
  <div class="content_secondary">
    ...
    <form action="<?php echo e(route('insurance')); ?>" class="was-validated" method="post">
      ...
      <div class="form-group<?php echo e($errors->has('full_name') ? ' has-error' : ''); ?>">
        ...
        <input type="text" class="form-control" id="full_name" placeholder="Enter Full Name" name="full_name" value="<?php echo e(old('full_name', session()->get('insurance_data.full_name'))); ?>">
      ...
      <div class="form-group<?php echo e($errors->has('car_number') ? ' has-error' : ''); ?>">
        ...
        <input type="text" class="form-control" id="car_number" placeholder="Enter Registered Car Number "name="car_number" value="<?php echo e(old('car_number', session()->get('insurance_data.car_number'))); ?>">
      ...
      <div class="form-group<?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
        ...
        <input type="text" class="form-control" id="mobile" placeholder="Enter Mobile Number" name="mobile" value="<?php echo e(old('mobile', session()->get('insurance_data.mobile'))); ?>">
      ...
      <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
        ...
        <input type="text" class="form-control" id="email" placeholder="Enter Email Address" name="email" value="<?php echo e(old('email', session()->get('insurance_data.email'))); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Final file\5\stillwaters\resources\views/insurances/create.blade.php ENDPATH**/ ?>