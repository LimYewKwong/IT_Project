    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-12">
        <div class="insurance_providers_container">
          ...
          <div class="insurance_providers_admin" data-price="<?php echo e($insurance->amount); ?>" data-sum="<?php echo e($insurance->sum_insured); ?>">
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                <span><b>Expiring On:</b> <?php echo e($insurance->end_date); ?></span>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 col-sm-12">
                <span><b>Sum Insured (SI):</b></span>
                <span class="headerfont_admin">RM <?php echo e(number_format($insurance->sum_insured, 2)); ?></span>
              </div>
              <div class="col-md-6 col-sm-12">
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Final file\5\stillwaters\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>