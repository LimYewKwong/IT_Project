        ...
        <div class="content_purchases">
            <div class="row">
                ...
                <?php if(isset($insurances)): ?>
                    ...
                    <?php else: ?>
                        <p style="color: white"><small>The search result of <b><?php echo e($adminsearch); ?></b> are:</small></p>
                    <?php endif; ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stillwaters\resources\views/admin/dashboardsearch.blade.php ENDPATH**/ ?>