  ...
  <div class="content_secondary">
    ...
    <form action="<?php echo e(route('insurance')); ?>" class="was-validated" method="post">
      ...
      <div class="form-group<?php echo e($errors->has('postcode') ? ' has-error' : ''); ?>">
        ...
        <input type="number" class="form-control" id="postcode" name="postcode" value="<?php echo e(old('postcode', session()->get('insurance_data.postcode'))); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\stillwaters\resources\views/insurances/create.blade.php ENDPATH**/ ?>