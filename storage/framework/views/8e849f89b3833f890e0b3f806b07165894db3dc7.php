                                ...
                                <div class="panel panel-primary panel-primary-insurance">
                                    ...
                                    <div class="panel-body addressField"><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-12">
                                                <input type="number" value="<?php echo e(session()->get('insurance_data.postcode')); ?>" class="form-control addressFields"  name="postcode">
                                            </div>
                                        </div><br>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stillwaters\resources\views/insurances/details.blade.php ENDPATH**/ ?>