...
<div class="container container_secondary">
  <div class="content_purchases">
    <div class="row">
      ...
      <form action="<?php echo e(route('searchpurchases')); ?>" method="POST" role="search">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stillwaters\resources\views/purchases.blade.php ENDPATH**/ ?>